...
def show_agency_menu(admin_name):
    ...
    explore_flights_btn = tk.Button(btn_frame, text="Explore Flights", width=40, height=2, bg="#00B2EE", activebackground="#009ACD",fg="white", borderwidth=0, command=show_flights_menu)
    explore_flights_btn.grid(row=0, column=0, padx=10)

    explore_destinations_btn = tk.Button(btn_frame, text="Explore Destinations", width=40, height=2, bg="#00B2EE", activebackground="#009ACD", fg="white", borderwidth=0, command=show_destinations_menu)
    explore_destinations_btn.grid(row=0, column=1, padx=10)

    book_a_trip_btn = tk.Button(btn_frame, text="Book a Trip", width=40, height=2, bg="#00B2EE", activebackground="#009ACD", fg="white", borderwidth=0, command=show_trip_menu)
